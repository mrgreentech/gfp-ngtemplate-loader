...
module.exports = function (content) {
    ...
    var options = (0, loaderUtils.getOptions)(this) || {};
    var ngModule = options.ngModule || 'ng'; // ng is the global angular module that does not need to explicitly required
    ...
    return "var path = '"+jsesc(filePath.substring(1))+"';\n" +
        "var html = " + html + ";\n" +
